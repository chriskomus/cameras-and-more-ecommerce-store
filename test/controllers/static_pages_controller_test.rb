...
class StaticPagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create static_page" do
    assert_difference("StaticPage.count") do
      post static_pages_url, params: { static_page: { body: @static_page.body, title: @static_page.title } }
    end
  ...
  test "should update static_page" do
    patch static_page_url(@static_page), params: { static_page: { body: @static_page.body, title: @static_page.title } }
